...
full_names = [name for name in full_names]
...
print("Integer Number Lists: ", numbers)

# TODO: use a list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
upper_nine = [number for number in numbers if number > 9]
print("Numbers greater than 9 :", upper_nine)